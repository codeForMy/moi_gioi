            ...
            <div class="front" style="min-height: 328.875px;">
                ...
                <div class="card-content">
                    <h5 class="category-social text-success">
                        <a href="{{ route('applicant.show', $post) }}" class="text-success">
                            <i class="fa fa-newspaper-o"></i> {{ $post->job_tittle }}
                        </a>
                    </h5>
                    <h4 class="card-title">
                        {{ $languages }}
                    ...
                    <div class="footer" style="display: flex; align-items: center; justify-content: space-between">
                        @isset($company)
                            <div class="author">
                                ...
                                <a href="#">
                                    <img src="{{ asset('/storage/images/company_logo/' . $company->logo) }}" class="avatar img-raised">
                ...
                @if ($post->is_not_available)
                    <span style="position: absolute; right: 10px; bottom: 10px; color: red">
