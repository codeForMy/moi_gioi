    ...
    return (function (t) {
        ...
        3: function (t, e, n) {
            ...
            function K(t) {
                ...
                return (
                    0 === e ||
                    (!I(t) && 1 === e && t.innerHTML === j) ||
                    !(!x.all(t.childNodes, I) || "" !== t.innerHTML)
                );
            }
            function q(t) {
                $(t) || W(t) || (t.innerHTML = j);
            ...
            function it(t, e) {
                ...
                if (0 === t.offset) {
                    ...
                    ot(t.node)
                        ? (o = W((n = t.node.childNodes[t.offset - 1])))
            ...
            function rt(t, e) {
                ...
                if (W(t.node) === t.offset) {
                    ...
                    if (((o = 0), K((n = t.node.childNodes[t.offset]))))
                        return null;
                } else if (
                    ((n = t.node), (o = e ? W(t.node) : t.offset + 1), K(n))
                )
                    return null;
                return { node: n, offset: o };
            }
            ...
            function st(t, e) {
                ...
                return (
                    Z(a, G(r)),
                    n || (q(t.node), q(a)),
                    i && (K(t.node) && ut(t.node), K(a))
                        ? (ut(a), t.node.nextSibling)
                        : a
                );
            }
            function lt(t, e, n) {
            ...
            var ft = {
                ...
                isCustomStyleTag: function (t) {
                    return (
                        t && !I(t) && x.contains(t.classList, "note-styletag")
                    );
                },
            };
            function pt(t, e) {
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                e.shouldInitialize() &&
                                    (e.events &&
                                        ft.detachEvents(this.$note, e.events),
                                    e.destroy && e.destroy()),
                ...
                var e = document.body.createTextRange(),
                    n = (function t(e, n) {
                        ...
                        if (ft.isText(e)) {
                            ...
                            if (((o = e.childNodes[n] || e), ft.isText(o)))
                                return t(o, 0);
                            (n = 0), (i = !1);
                        }
            ...
            var yt = (function () {
                    ...
                    return (
                        ...
                        (n = [
                                ...
                                value: function () {
                                    var e = function (t, e) {
                                            ...
                                            if (
                                                ft.isVisiblePoint(t) &&
                                                (!ft.isEdgePoint(t) ||
                                                    (ft.isRightEdgePoint(t) &&
                                                        !e) ||
                                                    (ft.isLeftEdgePoint(t) &&
                                                        e) ||
                                                    (ft.isRightEdgePoint(t) &&
                                                        e &&
                                                        ft.isVoid(
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (
                                        ft.isBodyContainer(this.sc) &&
                                        ft.isEmpty(this.sc)
                                    )
                                        return (
                                            (this.sc.innerHTML = ft.emptyPara),
                                            new t(
                                                this.sc.firstChild,
                                                0,
                                                this.sc.firstChild,
                                    ...
                                    var e,
                                        n = this.normalize();
                                    if (
                                        ft.isParaInline(this.sc) ||
                                        ft.isPara(this.sc)
                                    )
                                        return n;
                                    if (ft.isInline(n.sc)) {
                                        var o = ft.listAncestor(
                                            n.sc,
                                            b.not(ft.isInline)
                                        );
                                        (e = x.last(o)),
                ...
                kt = {
                    create: function (t, e, n, o) {
                        ...
                        if (!i && 1 === arguments.length) {
                            var r = arguments[0];
                            return (
                                ft.isEditable(r) && (r = r.lastChild),
                                this.createFromBodyElement(
                                    r,
                                    ft.emptyPara === arguments[0].innerHTML
                                )
                            );
                        }
                        return i;
                    ...
                    createFromSelection: function () {
                        ...
                        if (v.isW3CRangeSupport) {
                            ...
                            var c = gt(l, !0),
                                u = gt(s, !1);
                            ft.isText(c.node) &&
                                ft.isLeftEdgePoint(c) &&
                                ft.isTextNode(u.node) &&
                                ft.isRightEdgePoint(u) &&
                    ...
                    createFromNode: function (t) {
                        ...
                        return (
                            ft.isVoid(e) &&
                                ((n = ft.listPrev(e).length - 1),
                                (e = e.parentNode)),
                            ft.isBR(o)
                                ? ((i = ft.listPrev(o).length - 1),
                                  (o = o.parentNode))
                                : ft.isVoid(o) &&
                                  ((i = ft.listPrev(o).length),
                                  (o = o.parentNode)),
                            this.create(e, n, o, i)
                        );
                    },
                ...
                Ct = {
                    ...
                    isMove: function (t) {
                        return x.contains(
                            [wt.LEFT, wt.UP, wt.RIGHT, wt.DOWN],
                            t
                        );
                    },
                    isNavigation: function (t) {
                        return x.contains(
                            [wt.HOME, wt.END, wt.PAGEUP, wt.PAGEDOWN],
                            t
                        );
                    },
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                i.a.each(
                                    t.nodes(ft.isPara, { includeAncestor: !0 }),
                                    function (t, n) {
                                        i()(n).css(e);
                                    }
                                );
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                var a = ft.makePredByNodeName(n),
                                    s = t
                                        .nodes(ft.isText, { fullyContains: !0 })
                                        .map(function (t) {
                                            return (
                                                ft.singleChildAncestor(t, a) ||
                                                ft.wrap(t, n)
                                            );
                                        });
                                if (o) {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    (n.anchor =
                                        t.isOnAnchor() &&
                                        ft.ancestor(t.sc, ft.isAnchor)),
                                    (n.ancestors = ft.listAncestor(
                                        t.sc,
                                        ft.isEditable
                                    )),
                                    (n.range = t),
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                var n = x.head(t),
                                    o = x.last(t),
                                    i =
                                        ft.isList(n.previousSibling) &&
                                        n.previousSibling,
                                    r =
                                        ft.isList(o.nextSibling) &&
                                        o.nextSibling,
                                    a =
                                        i ||
                                        ft.insertAfter(ft.create(e || "UL"), o);
                                return (
                                    (t = t.map(function (t) {
                                        return ft.isPurePara(t)
                                            ? ft.replace(t, "LI")
                                            : t;
                                    })),
                                ...
                                return (
                                    i.a.each(t, function (t, r) {
                                        ...
                                        if ("LI" === l.parentNode.nodeName)
                                            ...
                                            (r = e
                                                ? ft.listDescendant(d, ft.isLi)
                                                : x
                                                      .from(d.childNodes)
                                                      .filter(ft.isLi)),
                                                (!e &&
                                                    ft.isList(l.parentNode)) ||
                                                    (r = r.map(function (t) {
                                                        return ft.replace(
                                                            t,
                                                            "P"
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return t.previousSibling
                                    ? ft.appendChildNodes(t.previousSibling, [
                                          t,
                                      ])
                                    : this.wrapList([t], "LI");
                            },
                    ...
                    (n = [
                        {
                            ...
                            value: function (t, e) {
                                var n = ft.createText(
                                    new Array(e + 1).join(ft.NBSP_CHAR)
                                );
                                (t = t.deleteContents()).insertNode(n, !0),
                                    (t = kt.create(n, e)).select();
                            },
                        },
                        {
                            key: "insertParagraph",
            ...
            (Lt.where = { Row: 0, Column: 1 }),
                (Lt.requestAction = { Add: 0, Delete: 1 }),
                (Lt.resultAction = {
                    Ignore: 0,
                    SubtractSpanCount: 1,
                    RemoveCell: 2,
                    ...
                    (this.insertParagraph = this.wrapCommand(function () {
                        ...
                        (this.insertNode = this.wrapCommand(function (t) {
                            n.isLimited(i()(t).text().length) ||
                                ...
                                n.setLastRange(
                                    kt.createFromNodeAfter(t).select()
                                ));
                        })),
                        (this.insertText = this.wrapCommand(function (t) {
                            if (!n.isLimited(t.length)) {
                                var e = n
                                    .getLastRange()
                                    .insertNode(ft.createText(t));
                                n.setLastRange(
                                    kt.create(e, ft.nodeLength(e)).select()
                                );
                            }
                        })),
                        (this.pasteHTML = this.wrapCommand(function (t) {
                            if (!n.isLimited(t.length)) {
                                ...
                                n.setLastRange(
                                    kt.createFromNodeAfter(x.last(e)).select()
                                );
                            }
                        })),
                        ...
                        (this.createLink = this.wrapCommand(function (t) {
                            ...
                            if (!(l > 0 && n.isLimited(l))) {
                                ...
                                var h = kt
                                        .createFromNodeBefore(x.head(u))
                                        .getStartPoint(),
                                    f = kt
                                        .createFromNodeAfter(x.last(u))
                                        .getEndPoint();
                                n.setLastRange(
                                    kt
                                        .create(
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                this.$editable
                                    ...
                                    this.$editable.html(
                                        ft.html(this.$note) || ft.emptyPara
                                    ),
                                    this.$editable.on(
                                        v.inputEventName,
                                        b.debounce(function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    ft.isEmpty(this.$editable[0]) ||
                                    ft.emptyPara === this.$editable.html()
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (
                                    ...
                                    var e = Mt.fromTextArea(
                                        this.$codable[0],
                                        this.options.codemirror
                                    );
                                    if (this.options.codemirror.tern) {
                                        var n = new Mt.TernServer(
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "handleKeyup",
                            value: function (t) {
                                x.contains(this.keys, t.keyCode) &&
                                    this.replace();
                            },
                        },
                    ]) && te(e.prototype, n),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return (
                                    ...
                                    -1 === v.genericFontFamilies.indexOf(t)
                                );
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return Object.keys(e)
                                    .map(function (n) {
                                        var o = e[n],
                                            r = i()(
                                                '<div><div class="help-list-item"/></div>'
                                            );
                                        return (
                                            r
                                                .append(
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                return (
                                    this.options.airMode &&
                                    !x.isEmpty(this.options.popover.air)
                                );
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (t.length) {
                                    ...
                                    if (
                                        ...
                                        i()(e).after(o),
                                            kt.createFromNodeBefore(o).select();
                            ...
                            value: function (t) {
                                this.$popover.is(":visible") &&
                                    (t.keyCode === Ct.code.ENTER
                                        ...
                                        : t.keyCode === Ct.code.UP
                                        ? (t.preventDefault(), this.moveUp())
                                        : t.keyCode === Ct.code.DOWN &&
                                          (t.preventDefault(),
                                          this.moveDown()));
                            },
                        },
