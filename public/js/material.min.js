...
var Arrive = (function (a, b, c) {
    "use strict";
    function l(a, b, c) {
        e.addMethod(b, c, a.unbindEvent),
            e.addMethod(b, c, a.unbindEventWithSelectorOrCallback),
            e.addMethod(b, c, a.unbindEventWithSelectorAndCallback);
    }
    function m(a) {
        (a.arrive = j.bindEvent),
            l(j, a, "unbindArrive"),
            (a.leave = k.bindEvent),
            l(k, a, "unbindLeave");
    }
    if (a.MutationObserver && "undefined" != typeof HTMLElement) {
        var d = 0,
            ...
            f = (function () {
                ...
                return (
                    ...
                    (a.prototype.removeEvent = function (a) {
                        for (
                            var c, b = this._eventsBucket.length - 1;
                            (c = this._eventsBucket[b]);
                            b--
                        )
                            a(c) &&
                                (this._beforeRemoving &&
                                    this._beforeRemoving(c),
                                this._eventsBucket.splice(b, 1));
                    }),
            ...
            g = function (b, d) {
                var g = new f(),
                    h = this,
                    i = { fireOnAttributesModification: !1 };
                return (
                    g.beforeAdding(function (c) {
                        var i,
                            e = c.target;
                        c.selector, c.callback;
                        (e === a.document || e === a) &&
                            (e = document.getElementsByTagName("html")[0]),
                            (i = new MutationObserver(function (a) {
                                d.call(this, a, c);
                            }));
                        var j = b(c.options);
            ...
            h = function () {
                function h(a) {
                    ...
                    return (
                        a.fireOnAttributesModification && (b.attributes = !0), b
                    );
                }
                function i(a, b) {
                    a.forEach(function (a) {
                        ...
                        null !== c && c.length > 0
                            ...
                            : "attributes" === a.type &&
                              k(d, b, f) &&
                              f.push({ callback: b.callback, elem: node }),
                            e.callCallbacks(f);
                    });
                }
                function k(a, b, f) {
                    if (
                        e.matchesSelector(a, b.selector) &&
                        (a._id === c && (a._id = d++),
                        -1 == b.firedElems.indexOf(a._id))
                    ) {
                        if (b.options.onceOnly) {
                            if (0 !== b.firedElems.length) return;
                            b.me.unbindEventWithSelectorAndCallback.call(
                                b.target,
                                b.selector,
                                b.callback
                            );
                        }
                        b.firedElems.push(a._id),
                            f.push({ callback: b.callback, elem: a });
                    }
                }
                var f = {
                    ...
                    (j.bindEvent = function (a, b, c) {
                        ...
                        if (b.existing) {
                            for (var g = [], h = 0; h < d.length; h++)
                                for (
                                    var i = d[h].querySelectorAll(a), j = 0;
                                    j < i.length;
                                    j++
                                )
                                    g.push({ callback: c, elem: i[j] });
                            if (b.onceOnly && g.length)
                                return c.call(g[0].elem);
            ...
            i = function () {
                ...
                function f(a, b) {
                    a.forEach(function (a) {
                        ...
                        null !== c &&
                            c.length > 0 &&
                            e.checkChildNodesRecursively(c, b, h, f),
                            e.callCallbacks(f);
                    });
                }
                function h(a, b) {
            ...
            k = new i();
        b && m(b.fn),
            m(HTMLElement.prototype),
            m(NodeList.prototype),
            m(HTMLCollection.prototype),
            m(HTMLDocument.prototype),
            m(Window.prototype);
        var n = {};
...
!(function (t) {
    ...
    (t.expr[":"].notmdproc = function (o) {
        ...
        (t.material = {
            ...
            checkbox: function (o) {
                var i = t(o ? o : this.options.checkboxElements)
                    .filter(":notmdproc")
                    .data("mdproc", !0)
                    .after(
            ...
            togglebutton: function (o) {
                var i = t(o ? o : this.options.togglebuttonElements)
                    .filter(":notmdproc")
                    .data("mdproc", !0)
            ...
            radio: function (o) {
                var i = t(o ? o : this.options.radioElements)
                    .filter(":notmdproc")
                    .data("mdproc", !0)
                    .after(
            ...
            input: function (o) {
                t(o ? o : this.options.inputElements)
                    .filter(":notmdproc")
                    .data("mdproc", !0)
                    .each(function () {
                        var o = t(this),
                        ...
                        if (
                            (t.each(n, function (t, n) {
                                o.hasClass(t) &&
                                    (o.removeClass(t), i.addClass(n));
                            }),
                            o.hasClass("floating-label"))
                        ) {
                            var e = o.attr("placeholder");
                            o.attr("placeholder", null).removeClass(
                                "floating-label"
                            );
                            var a = o.attr("id"),
                                r = "";
                ...
                t(document)
                    ...
                    .on("keyup change", ".form-control", function () {
                        var o = t(this),
                            i = o.closest(".form-group"),
                            e =
                                "undefined" == typeof o[0].checkValidity ||
                                o[0].checkValidity();
                        "" === o.val()
                            ? i.addClass("is-empty")
            ...
            init: function (o) {
                ...
                t.fn.ripples && this.options.ripples && this.ripples(),
                    ...
                    document.arrive &&
                        ...
                        this.options.input &&
                            i.arrive(this.options.inputElements, function () {
                        ...
                        this.options.radio &&
                            i.arrive(this.options.radioElements, function () {
        ...
        (e.prototype.init = function () {
            ...
            i.on("mousedown touchstart", function (n) {
                if (!r.isTouch() || "mousedown" !== n.type) {
                    i.find(".ripple-container").length ||
                        i.append('<div class="ripple-container"></div>');
                    ...
                    if (a || s) {
                        ...
                        p
                            .addClass("ripple")
                            .css({ left: s, top: a, "background-color": l }),
                            e.append(p),
                            (function () {
            ...
            (e.prototype.getRelX = function (t, o) {
                ...
                return r.isTouch()
                    ? ((o = o.originalEvent),
                      1 === o.touches.length ? o.touches[0].pageX - i.left : !1)
                    : o.pageX - i.left;
            }),
            (e.prototype.getRelY = function (t, o) {
                ...
                return r.isTouch()
                    ? ((o = o.originalEvent),
                      1 === o.touches.length ? o.touches[0].pageY - i.top : !1)
                    : o.pageY - i.top;
            }),
            (e.prototype.getRipplesColor = function (t) {
                var i = t.data("ripple-color")
                    ? t.data("ripple-color")
            ...
            (e.prototype.rippleOn = function (t, o) {
                ...
                r.hasTransitionSupport()
                    ...
                    : o.animate(
                          {
                              width:
                                  2 * Math.max(t.outerWidth(), t.outerHeight()),
                              height:
                                  2 * Math.max(t.outerWidth(), t.outerHeight()),
                              "margin-left":
                                  -1 *
            ...
            (t.fn.ripples = function (o) {
                return this.each(function () {
                    t.data(this, "plugin_" + a) ||
                        t.data(this, "plugin_" + a, new e(this, o));
                });
            });
